...
/**
 * Class to read a gzipped ARFF file
 */
public class BufferedArffMatrixReader implements ITokenStream<DocumentTermMatrixFileEntry>
{
	private File file;
	 ...
	 */
	public BufferedArffMatrixReader(File _file) throws IOException
	{
		file = _file;
